...
```mermaid
flowchart TD
  Q["Singular het-word?"] -->|"yes"| A["ons — ons huis, ons land"]
  Q -->|"no — de-word or any plural"| B["onze — onze auto, onze kinderen"]
```
...
The same stress principle runs through the pronouns: *je* vs *jij*, *ze* vs *zij*. See [Pronouns](/#/grammar?doc=3-pronouns/50-pronouns.md).
