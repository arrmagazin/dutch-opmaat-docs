...
```mermaid
flowchart TD
  Q["Which future?"] -->|"fixed schedule / known time"| A["present + tijdwoord — Ik werk morgen"]
  Q -->|"personal plan / intention"| B["gaan + infinitief — Ik ga werken"]
  Q -->|"promise, prediction, shall we?"| C["zullen + infinitief — Ik zal het doen"]
```
