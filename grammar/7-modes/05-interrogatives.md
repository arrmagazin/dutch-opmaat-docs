...
Any non-finite verb (infinitive, participle) or separable prefix still goes to the **end** of the clause. For the full inventory of question words (*wie, wat, welk(e), hoe, waarom, hoeveel …*), see [question words](/#/grammar?doc=3-pronouns/60-vraag-worden.md).
...
> Two prepositions change shape here: *met → mee*, *tot → toe* (so *waarmee*, *waartoe*). The split form is more natural in speech; the joined form is more formal. This mirrors *er*-words — see [question words](/#/grammar?doc=3-pronouns/60-vraag-worden.md).
