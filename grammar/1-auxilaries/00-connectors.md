...
| Dutch | English | Example |
|-------|---------|---------|
| `note:zo-als` | as [quality] as [etalon] | Hij is **zo** groot **als** ik. |
| `note:even-als` | same as [quality] as [etalon] | Zij loopt **even** snel **als** hij. |
| `note:net-zo-als` | just as [quality] as [etalon] | Dit is **net zo** duur **als** dat. |
