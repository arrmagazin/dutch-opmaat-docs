...
| Dutch | English | Example |
|-------|---------|---------|
| `zo … dat` | so [condition] that [outcome] | Het was **zo** koud **dat** ik bibberde. |
...
| Dutch | English | Example |
|-------|---------|---------|
| `eerst` / `dan` | first / then | **Eerst** drink ik koffie, **dan** ga ik werken. |
| `toen` | then (past) | **Toen** was ik nog jong. |
| `daarna`, `vervolgens` | after that, next | We eten; **daarna** kijken we een film.**Vervolgens** namen we de fiets. |
