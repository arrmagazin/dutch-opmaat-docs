...
> The *f→v / s→z* shift keeps the consonant in a few words: *de elf → de elfen*, *de kaars → de kaarsen*. The same three shifts run through [Plurals](/#/grammar?doc=4-nouns/62-plurals.md), [Adjectives](/#/grammar?doc=2-decorators/34-adjectives.md), and [Comparatives](/#/grammar?doc=2-decorators/36-comparatives.md).
